                ...
                if (repeat > 0) {
                    if (canx == 1) {
                        ...
                        for (let index2 = 0; index2 <= TileCollisionArrayX.length; index2++) {
                            if (canx == 1) {
                                if (TileCollisionArrayX[index2] - mySprite.left + 1.5 >= 0 && TileCollisionArrayX[index2] - mySprite.left - 1.5 <= mySprite.width && (TileCollisionArrayY[index2] - mySprite.top + 1.5 > 0 && TileCollisionArrayY[index2] - mySprite.top - 1.5 < mySprite.height)) {
                    ...
                    if (cany == 1) {
                        ...
                        for (let index22 = 0; index22 <= TileCollisionArrayY.length; index22++) {
                            if (cany == 1) {
                                if (TileCollisionArrayX[index22] - mySprite.left + 1.5 >= 0 && TileCollisionArrayX[index22] - mySprite.left - 1.5 <= mySprite.width && (TileCollisionArrayY[index22] - mySprite.top + 1.5 > 0 && TileCollisionArrayY[index22] - mySprite.top - 1.5 < mySprite.height)) {
